...
def create_comprehensive_ranking_visualization(df_ranked):
    ...
    plt.tight_layout()
    plt.savefig(f'./cartpole/dqn/cra/{env_name}_{alg_name}_cra.png', dpi=300, bbox_inches='tight')
    plt.show()
...
def create_ranking_summary_table(df_ranked):
    ...
    print("="*100)
    print("COMPREHENSIVE CONFIGURATION RANKING ANALYSIS")
    print("="*100)
    print()
...
def generate_recommendations(df_ranked):
    ...
    print("\n" + "="*80)
    print("🎯 OPTIMIZATION RECOMMENDATIONS FOR THESIS")
    print("="*80)
    print()
    ...
    print("2. KEY INSIGHTS FOR 2D GAME OPTIMIZATION:")
    print("-" * 45)
    print("   • Systematic hyperparameter optimization improves performance significantly")
    ...
    print("   • Statistical validation with multiple seeds is essential")
    print()
    
    print("3. CRITICAL SUCCESS FACTORS:")
    print("-" * 35)
    print("   • Learning rate selection is crucial for convergence")
    print("   • Target update rate requires careful tuning (too high/low both fail)")
    print("   • Multiple random seeds reveal configuration robustness")
    print("   • Performance stability as important as mean performance")
    print()
    
    print("4. IMPLICATIONS FOR COMPLEX ENVIRONMENTS:")
    print("-" * 45)
    print("   • If simple CartPole requires optimization, complex games need it more")
    print("   • These optimal parameters provide starting point for other environments")
    print("   • Methodology demonstrates systematic approach to RL optimization")

def main():
    """Run comprehensive configuration ranking analysis"""
    
    json_file = f'./cartpole/dqn/json_data/{env_name}_{alg_name}_hp.json'
